...
public interface DeviceDAO {
    ...
    /**
     * Enrolls the device in Biometric device store when username, device ID
    ...
    /**
     * Unenrolls a device that is already enrolled in Biometric device store
     * when username and device ID are provided by the user.
     */
    void unenrollDevice(String username, String deviceID);

    /**
     * Returns the device ID from the Biometric device store when username is provided.
     */
