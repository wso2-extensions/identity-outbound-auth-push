...
package org.wso2.carbon.identity.application.authenticator.push.core.internal;
 ...
 */
@Component(
        name = "identity.application.authenticator.push.core.component",
        immediate = true)
public class PushCoreServiceComponent {

    private static RealmService realmService;

    private static Log log = LogFactory.getLog(PushCoreServiceComponent.class);
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        try {
            ...
            ctxt.getBundleContext().registerService(ApplicationAuthenticator.class.getName(), contextManager, null);
