...
@PrepareForTest({DeviceDAOImpl.class, BiometricDeviceHandlerCacheKey.class, DeviceCache.class,
...
public class BiometricDeviceHandlerTest {
    @Mock
    ...
    public void setUp() {
        ...
        mockStatic(BiometricDeviceHandlerCacheKey.class);
